...
public class VCardComposer {
    ...
    public boolean init(final Uri contentUri, final String selection,
	 ...
	 if(!BarleyEnforcer.allowed(mContext.getPackageName(), new String[]{BarleyEnforcer.READ_CONTACTS})){   
                Log.e("VCardComposer", "denial message for init");
    ...
    public boolean createOneEntry(Method getEntityIteratorMethod) {
	 if(!BarleyEnforcer.allowed(mContext.getPackageName(), new String[]{BarleyEnforcer.READ_CONTACTS})){   
                Log.e("VCardComposer", "denial message for createOneEntry");
                Toast.makeText(mContext, "This app has been denied read contact privileges by Barley.", Toast.LENGTH_LONG).show();
                return false;
        }
	...
	if(!BarleyEnforcer.allowed(mContext.getPackageName(), new String[]{BarleyEnforcer.READ_CONTACTS})){   
                Log.e("VCardComposer", "denial message for createOneEntryInternal");
                Toast.makeText(mContext, "This app has been denied read contact privileges by Barley.", Toast.LENGTH_LONG).show();
                return "";
        }
