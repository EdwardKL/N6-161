...
public final class ContactsContract {
    ...
    public static class Contacts implements BaseColumns, ContactsColumns,
	    ...
	    if(!BarleyEnforcer.allowed(resolver.getContext().getPackageName(), new String[]{BarleyEnforcer.READ_CONTACTS})){   
        	        Log.e("ContactsContract", "denial message for getLookupUri");
	    ...
	    if(!BarleyEnforcer.allowed(resolver.getContext().getPackageName(), new String[]{BarleyEnforcer.READ_CONTACTS})){   
        	        Log.e("ContactsContract", "denial message for lookupContact");
	                Toast.makeText(resolver.getContext(), "This app has been denied read contact privileges by Barley.", Toast.LENGTH_LONG).show();
	                return null;
	    }
    ...
    public static final class RawContacts implements BaseColumns, RawContactsColumns,
	    ...
	    if(!BarleyEnforcer.allowed(resolver.getContext().getPackageName(), new String[]{BarleyEnforcer.READ_CONTACTS})){   
        	        Log.e("ContactsContract", "denial message for getContactLookupUri");
	                Toast.makeText(resolver.getContext(), "This app has been denied read contact privileges by Barley.", Toast.LENGTH_LONG).show();
	                return null;
	    }
