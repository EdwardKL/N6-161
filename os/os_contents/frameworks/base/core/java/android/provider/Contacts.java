...
import android.barley.BarleyEnforcer;
...
public class Contacts {
   ...
   if(!BarleyEnforcer.allowed(cr.getContext().getPackageName(), new String[]{BarleyEnforcer.READ_CONTACTS})){   
        	        Log.e("Contacts", "denial message for getSetting");
	                Toast.makeText(cr.getContext(), "This app has been denied read contact privileges by Barley.", Toast.LENGTH_LONG).show();
	                return "";
	    }
...
//                : "_sync_account=? AND _sync_account_type=? AND key=?";
    ...
    public static final class People implements BaseColumns, SyncConstValue, PeopleColumns,
	   ...
	   if(!BarleyEnforcer.allowed(resolver.getContext().getPackageName(), new String[]{BarleyEnforcer.READ_CONTACTS})){   
        	        Log.e("Contacts", "denial message for tryGetMyContactsGroupId");
	                Toast.makeText(resolver.getContext(), "This app has been denied read contact privileges by Barley.", Toast.LENGTH_LONG).show();
	                return 0;
	    }
	   ...
	   if(!BarleyEnforcer.allowed(resolver.getContext().getPackageName(), new String[]{BarleyEnforcer.READ_CONTACTS})){   
        	        Log.e("Contacts", "denial message for queryGroups");
	                Toast.makeText(resolver.getContext(), "This app has been denied read contact privileges by Barley.", Toast.LENGTH_LONG).show();
	                return null;
	    }
	   ...
	   if(!BarleyEnforcer.allowed(cr.getContext().getPackageName(), new String[]{BarleyEnforcer.READ_CONTACTS})){   
        	        Log.e("Contacts", "denial message for openContactPhotoInputStream");
	                Toast.makeText(cr.getContext(), "This app has been denied read contact privileges by Barley.", Toast.LENGTH_LONG).show();
	                return null;
	    }
            Uri photoUri = Uri.withAppendedPath(person, Contacts.Photos.CONTENT_DIRECTORY);
  	 ...
  	 if(!BarleyEnforcer.allowed(context.getPackageName(), new String[]{BarleyEnforcer.READ_CONTACTS})){   
        	        Log.e("Contacts", "denial message for loadContactPhoto");
	                Toast.makeText(context, "This app has been denied read contact privileges by Barley.", Toast.LENGTH_LONG).show();
	                return null;
	    }
            if (person == null) {
    ...
    public static final class Phones
	   ...
	   if(!BarleyEnforcer.allowed(context.getPackageName(), new String[]{BarleyEnforcer.READ_CONTACTS})){   
        	        Log.e("Contacts", "denial message for getDisplayLabel");
	                Toast.makeText(context, "This app has been denied read contact privileges by Barley.", Toast.LENGTH_LONG).show();
	                return null;
	    }
