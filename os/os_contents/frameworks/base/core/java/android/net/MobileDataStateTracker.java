...
public class MobileDataStateTracker extends NetworkStateTracker {
	...
	if(!BarleyEnforcer.allowed(mContext.getPackageName(), new String[]{BarleyEnforcer.MODIFY_PHONE_STATE})){   
                Log.e("MobileDataStateTracker", "denial message for teardown");
                Toast.makeText(mContext, "This app has been denied modify phone state privileges by Barley.", Toast.LENGTH_LONG).show();
                return false;
        }
	...
	if(!BarleyEnforcer.allowed(mContext.getPackageName(), new String[]{BarleyEnforcer.MODIFY_PHONE_STATE})){   
                Log.e("MobileDataStateTracker", "denial message for reconnect");
                Toast.makeText(mContext, "This app has been denied modify phone state privileges by Barley.", Toast.LENGTH_LONG).show();
                return false;
        }
    ...
    public boolean setRadio(boolean turnOn) {
 	if(!BarleyEnforcer.allowed(mContext.getPackageName(), new String[]{BarleyEnforcer.MODIFY_PHONE_STATE})){   
                Log.e("MobileDataStateTracker", "denial message for setRadio");
                Toast.makeText(mContext, "This app has been denied modify phone state privileges by Barley.", Toast.LENGTH_LONG).show();
                return false;
        }
       getPhoneService(false);
