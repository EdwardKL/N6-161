...
public class QuickContactBadge extends ImageView implements OnClickListener {
	...
	if(!BarleyEnforcer.allowed(mContext.getPackageName(), new String[]{BarleyEnforcer.READ_CONTACTS})){   
                Log.e("QuickContactBadge", "denial message for assignContactFromEmail");
                Toast.makeText(mContext, "This app has been denied read contact privileges by Barley.", Toast.LENGTH_LONG).show();
                return;
        }
	...
	if(!BarleyEnforcer.allowed(mContext.getPackageName(), new String[]{BarleyEnforcer.READ_CONTACTS})){   
                Log.e("QuickContactBadge", "denial message for assignContactFromPhone");
                Toast.makeText(mContext, "This app has been denied read contact privileges by Barley.", Toast.LENGTH_LONG).show();
                return;
        }
	...
	if(!BarleyEnforcer.allowed(mContext.getPackageName(), new String[]{BarleyEnforcer.READ_CONTACTS})){   
                Log.e("QuickContactBadge", "denial message for trigger");
                Toast.makeText(mContext, "This app has been denied read contact privileges by Barley.", Toast.LENGTH_LONG).show();
                return;
        }
