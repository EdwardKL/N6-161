...
public class TelephonyManager {
	...
	if (BarleyEnforcer.allowed(mContext.getPackageName(), new String[]{BarleyEnforcer.READ_PHONE_STATE})){	
	        try {
		...
		Toast.makeText(mContext, "This app has requested to read phone state but has been denied by Barley.", Toast.LENGTH_LONG).show();
		return null;
	}	
    }
